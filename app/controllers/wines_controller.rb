class WinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @wine.save
        format.html { redirect_to wines_url, notice: "Wine was successfully created." }
        format.json { render :show, status: :created, location: @wine }
      else
        format.turbo_stream { render turbo_stream: turbo_stream.replace(@wine, partial: "wines/form", locals: { wine: @wine }) }
